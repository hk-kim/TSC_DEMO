...
<script language = "JavaScript">
	function checkSubmit(passWord, num, pageNum, product){
		...
		if(str == passWord){
			alert("비밀번호 일치");
			opener.location.href = "updateForm.jsp?product="+product+"&num="+num+"&pageNum="+pageNum;
			window.close();
		}
		else{
	...
	function cancleUpdate(product, num, pageNum){
	...
	<form name="checkForm" method = POST>
		<table cellpadding = 0 cellspacing = 0 border = 0 align = "center">
			...
			<tr>
				...
				<td><a href = "#" onclick = "cancleUpdate('<%=product%>', '<%=num%>', '<%=pageNum%>');">취소</a></td>
			</tr>
		</table>
	</form>
</body>
